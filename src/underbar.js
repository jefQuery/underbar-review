(function() {
  ...
  _.every = function(collection, iterator) {
    ...
    return _.reduce(collection, function(allTrue, curr) {
      return allTrue && !!iterator(curr);
    }, true);
  };
  ...
  _.some = function(collection, iterator) {
    ...
    return _.reduce(collection, function(oneTrue, curr) {
      return oneTrue || !!iterator(curr);
    }, false);
